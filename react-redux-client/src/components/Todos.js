...
export default class Todos extends React.Component {
  ...
  render() {
    ...
    return ( <
      ...
      <
      h3 className = "centerAlign" > Todos < /h3> {!todos && todoState.isFetching &&
      <
      p > Loading todos.... < /p>
    } {
      ...
      todos && todos.length > 0 && !todoState.isFetching &&
        ...
        tbody > {
          todos.map((todo, i) => < tr key = {
            ...
            td className = "textCenter" > < Button onClick = {
            ...
            <
            td className = "textCenter" > < Button onClick = {
              () => this.showDeleteModal(todo)
            }
            bsStyle = "danger"
            bsSize = "xsmall" > < Glyphicon glyph = "trash" / > < /Button></td >
            <
            td className = "textCenter" > < Link to = {
              `/${todo._id}`
